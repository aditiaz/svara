export const Modal = ({ modal, handleModal, addToFave, value, onChange }) => {
  return (
    <div
      hidden={modal}
      className=" fixed top-0 bottom-0 left-0 right-0 bg-opacity-25  bg-transparent"
    >
      <div className=" rounded-lg relative top-[40%] left-[40%] border border-[2px] border-white bg-[#EFEFEF] bg-opacity-50 w-[30rem] h-[12rem] ">
